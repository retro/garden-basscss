(defproject org.clojars.mihaelkonjevic/garden-basscss "0.2.2"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                :compiler {:main garden-basscss.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/garden_basscss.js"
               ...
               {:id "min"
                :source-paths ["src"]
                :compiler {:output-to "resources/public/js/compiled/garden_basscss.js"
                           :main garden-basscss.core
